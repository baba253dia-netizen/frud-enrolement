      ...
      <div style={{ maxWidth: 500, margin: "0 auto", padding: 20 }}>
        ...
        {confirmation && (
          <div style={{ textAlign: "center", paddingTop: 40 }}>
            ...
            <p style={{ color: "#999", fontSize: 14 }}>Redirection automatique...</p>
          </div>
        )}
                ...
                {membres.map((m, i) => (
                  <div key={m.id} style={{ background: "white", padding: 15, borderRadius: 10, border: "1px solid #eee" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                      ...
                      <span style={{ background: m.statut === "VALIDÉ" ? "#dcfce7" : "#fef3c7", color: m.statut === "VALIDÉ" ? "#16a34a" : "#b45309", padding: "3px 10px", borderRadius: 12, fontSize: 12, fontWeight: "bold" }}>
                        {m.statut}
                      </span>
                    </div>
